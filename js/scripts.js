...
class UI {
  ...
  compraFinal() {
    const div = document.createElement("div");
    div.classList.add("carrito__final");
    div.innerHTML = `<p class="text1">Gracias por su compra</p>
    <p class="text1" >Su pedido llegara en breve!</p>
    <p></p>
    <h1 class="text2">Rifat <span class="yellow">Watches</span></h1>`;
